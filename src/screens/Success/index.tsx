...
function Success(): JSX.Element {
  ...
  return (
    <View style={styles.container}> 
      <View>
        ...
        <View style={styles.overlay}>
          ...
          <View style={styles.label}>
            ...
            <Text style={Gs.textWhite}>Pantai Papua No. 2</Text>
          </View> 
        </View>
      </View>
      ...
      <TouchableOpacity style={styles.detailsButtom} onPress={async() => {
        navigation.navigate('Details');
        await analytics().logEvent('button_SuccesstoDetails');
      }}>
