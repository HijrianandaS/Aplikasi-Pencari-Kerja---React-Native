...
function Home(): JSX.Element {
  ...
  const handlePress = () => {
    ...
    analytics().logEvent('button_Details');
  }

  const newsworthyData = [
    {
      title: 'Hajime',
      address: 'Pantai Selatan No. 3',
      price: '$421/day',
      image: require('../../../assets/images/item_2_a.png'),
    },
    {
      title: 'DeepWork',
      address: 'Pantai Barat No. 1',
      price: '$421/day',
      image: require('../../../assets/images/item_3_b.png'),
    },
  ]
    ...
    return(
      <View style={styles.sectionContainer}>
        <InputText 
          ...
          placeholder="Find your spaces in Jakarta"
        />
      </View>
    );
  };
